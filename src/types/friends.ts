...
export interface FriendsDataRow {
	...
	specialMoveEffect: string;
	waitSkillName: string;
	waitSkillEffect: string;
	waitSkillActivationRate: string;
	waitSkillActivationCount: string;
	traitName: string;
	traitEffect: string;
	kisekitraitName: string;
	kisekitraitEffect: string;
