...
export const FriendsAttributeIconAndName = memo(function FriendsAttributeIconAndName({
	attribute,
}: FriendsAttributeIconAndNameProps) {
	const textColor = friendsAttributeColor[attribute];
	const iconUrl = friendsAttributeIconUrl[attribute];

	return (
		<>
			<div style={{ color: textColor }} className="flex flex-col items-center">
