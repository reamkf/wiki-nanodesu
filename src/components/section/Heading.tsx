 ...
 */
export function Heading({ title, id, level = 1, className }: SectionHeadingProps) {
	...
	const getBorderClasses = () => {
		switch (level) {
			case 1:
				return "border-b-[3px] border-[#2196f3] bg-[#f5f5f5]";
			case 2:
				return "border-b-2 border-[#2196f3] bg-transparent";
			case 3:
				return "border-b border-[#808080] bg-transparent";
			default:
				return "border-b-2 border-[#2196f3] bg-[#f5f5f5]";
		}
	};
	...
	const getTypographyClasses = () => {
		const fontSize =
			level === 1 ? "text-[1.1rem]" : level === 2 ? "text-[1rem]" : "text-[0.9rem]";
