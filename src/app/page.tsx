...
export default function Home() {
	return (
		<>
			<h2 className="text-xl font-bold mb-4">トップページ</h2>
			...
			<div className="mt-4">
				<Image src="https://image02.seesaawiki.jp/k/h/kemono_friends3_5ch/qUJbC4v4sZ.jpg" alt="メインビジュアル" width={750} height={300} />
			</div>
		</>
	)
}